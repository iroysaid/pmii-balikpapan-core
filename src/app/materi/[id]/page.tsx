...
export default async function MaterialDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-8">
            <Link href="/materi" className="text-secondary hover:text-primary flex items-center mb-6 text-sm font-bold w-fit">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="space-y-8">
                    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                        ...
                        <div className="space-y-4">
                            {otherMaterials.length === 0 ? (
                                ...
                                otherMaterials.map((item) => (
                                    <Link key={item.id} href={`/materi/${item.id}`} className="group flex gap-3 items-start p-2 rounded-lg hover:bg-gray-50 transition">
                        ...
                        <Link href="/materi" className="block text-center text-sm font-bold text-primary mt-6 hover:underline">
