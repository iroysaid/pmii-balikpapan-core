...
import { deleteMaterial } from "@/app/actions/learning";
                        ...
                        {materials.map((item) => (
                            <tr key={item.id} className="hover:bg-gray-50 transition">
                                ...
                                <td className="p-4 flex justify-end space-x-2">
                                    <Link href={`/learning/${item.id}`} className="text-gray-400 hover:text-blue-500 p-1" title="Lihat">
                                        <Eye className="w-4 h-4" />
                                    </Link>

                                    {canEdit && (
                                        <>
                                            <Link href={`/dashboard/learning/edit/${item.id}`} className="text-gray-400 hover:text-green-500 p-1" title="Edit">
