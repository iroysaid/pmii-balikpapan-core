...
import { updateMaterial } from "@/app/actions/learning";
        ...
        <form action={updateMaterialWithId} className="space-y-8">
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 space-y-6">
                ...
                <div className="flex items-center space-x-2">
                    <input type="checkbox" name="isPublished" value="true" defaultChecked={material.isPublished} id="publish" className="w-4 h-4 text-primary" />
                    <label htmlFor="publish" className="text-sm text-primary font-bold">Publikasikan?</label>
                </div>
            </div>
