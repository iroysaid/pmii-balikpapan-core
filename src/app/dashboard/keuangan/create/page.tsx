...
export default async function CreateTransactionPage() {
    ...
    return (
        <div className="max-w-6xl mx-auto">
            <div className="mb-8">
                <Link href="/dashboard/keuangan" className="text-secondary hover:text-primary flex items-center mb-4 text-sm font-bold">
                ...
                <div className="lg:col-span-5 space-y-4">
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div className="p-3 bg-gray-50 text-center border-t border-gray-100">
                            <Link href="/dashboard/keuangan" className="text-xs text-secondary hover:text-primary font-bold">
